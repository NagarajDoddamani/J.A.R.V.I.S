...
class OrchestratorOutboxPort(Protocol):
    """Transactional outbox port for orchestrator domain events.

    When an orchestration, workflow, or step aggregate changes state,
    ...
    def mark_published(self, aggregate_id: str) -> None:
        ...
        aggregate_id:
            ...
            representation of ``OrchestrationId``, ``WorkflowId``,
            or the step ``WorkflowId``).
        """
        ...
