...
class FailTaskUseCase:
    ...
    def execute(
        ...
        event = AgentFactory.fail_task(
            agent=agent, task_id=task_id, reason=request.failure_reason,
        )
        ...
        return TaskLifecycleResponse(
            ...
            failure_reason=task.failure_reason.value if task.failure_reason else None,
        )
