...
class ExpireNotificationUseCase:
    def __init__(
        self,
    ...
    def execute(
        self, request: ExpireNotificationRequest
    ) -> ExpireNotificationResponse:
        ...
        event = NotificationFactory.expire_notification(notification)
        self._notification_repo.save(notification)
        self._outbox.append(event)

        return ExpireNotificationResponse(
