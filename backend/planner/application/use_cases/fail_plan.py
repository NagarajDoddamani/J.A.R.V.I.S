...
from backend.planner.domain.model import FailureReason, PlanId


class FailPlanUseCase:
    def __init__(
        self,
    ...
    def execute(self, request: FailPlanRequest) -> FailPlanResponse:
