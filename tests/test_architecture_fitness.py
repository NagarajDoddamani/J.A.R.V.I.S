...
ALLOWED_ADAPTER_PATHS = {
    ...
    "backend/planner/adapters",
    "backend/research/adapters",
    "backend/orchestrator/adapters",
    "backend/orchestrator/bootstrap.py",
    "backend/orchestrator/nats.py",
    "backend/policy/adapters",
    "backend/policy/bootstrap.py",
    "backend/policy/nats.py",
    "backend/api/endpoints/policy.py",
    "backend/agent/adapters",
    "backend/agent/bootstrap.py",
    "backend/agent/nats.py",
    "backend/automation/adapters",
    ...
    "backend/planner/bootstrap.py",
    "backend/planner/nats.py",
